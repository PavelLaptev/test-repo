import type { Octokit, RestEndpointMethodt--change--ypes } from '@octokit/rest';
...
export function processPullRequestApiResponse(
  pr:
    | RestEndpointMethodt--change--ypes['search']['issuesAndPullRequests']['response']['da--change--ta']['items'][number]
    | RestEndpointMethodt--change--ypes['repos']['listPullRequestsAssociatedWithCommit']['response']['da--change--ta'][number],
  authorEmail?: string,
): IPullRequest {
